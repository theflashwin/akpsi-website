...
export default function ImageTrack(props) {
    ...
    return (
        ...
        <div className="mt-56 w-full h-full relative ">
            <div ref={trackRef} id="image-track" data-mouse-down-at="0" data-prev-percentage="0" data-percentage="0" data-mouse-down="0" data-previous="0">

                {props.images.map((element) => {
                    return (
                        <img class="image" src={element.image} onClick={() => {

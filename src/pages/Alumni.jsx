...
import AlumniWrapper from "../components/Wrappers/AlumniWrapper";
...
export default function Alumni() {
    ...
    return (
        ...
        <div className="font-serif w-screen h-screen overflow-x-hidden">
            ...
            <div className="flex">
                ...
                <div className={`w-full transition-all duration-500 ${toggled ? "ml-56" : "ml-20"
                    }`}>
                    <AlumniWrapper/>
                </div>
